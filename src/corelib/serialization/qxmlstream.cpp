 ...
 */
static QStringView contextString(QXmlStreamReaderPrivate::XmlContext ctxt)
{
    switch (ctxt) {
    case QXmlStreamReaderPrivate::Prolog:
        return QStringViewLiteral("Prolog");
    case QXmlStreamReaderPrivate::Body:
        return QStringViewLiteral("Body");
    }
    return QStringView();
}
...
void QXmlStreamReaderPrivate::checkToken()
{
    ...
    if (!ok) {
        raiseError(QXmlStreamReader::UnexpectedElementError,
                   ...
                   .arg(q->tokenString()).arg(contextString(context)));
        return;
    }
